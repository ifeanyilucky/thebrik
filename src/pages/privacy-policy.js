        ...
        <Stack spacing={3} my={5}>
          <Stack spacing={2}>
            ...
            <Typography variant="body2">
              At www.thebrik.co, accessible from https://www.thebrik.co/, one of our main priorities
              is the privacy of our visitors. This Privacy Policy document contains types of
              information that is collected and recorded by www.thebrik.co and how we use it. If you
              have additional questions or require more information about our Privacy Policy, do not
              hesitate to contact us. This Privacy Policy applies only to our online activities and
              is valid for visitors to our website with regards to the information that they shared
              and/or collect in www.thebrik.co. This policy is not applicable to any information
          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body2">
              ...
              the message and/or attachments you may send us, and any other information you may
          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body2">
              www.thebrik.co follows a standard procedure of using log files. These files log
          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body2">
              ...
              partners of www.thebrik.co. Third-party ad servers or ad networks uses technologies
              like cookies, JavaScript, or Web Beacons that are used in their respective
              advertisements and links that appear on www.thebrik.co, which are sent directly to
              ...
              Note that www.thebrik.co has no access to or control over these cookies that are used
          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body2">
              ...
              complete the information you believe is incomplete. The right to erasure – You have
              the right to request that we erase your personal data, under certain conditions. The
              ...
              processing – You have the right to object to our processing of your personal data,
              under certain conditions. The right to data portability – You have the right to
              request that we transfer the data that we have collected to another organization, or
              directly to you, under certain conditions. If you make a request, we have one month to
          ...
          <Stack spacing={1}>
            ...
            <Typography variant="body2">
              ...
              monitor and guide their online activity. www.thebrik.co does not knowingly collect any
              Personal Identifiable Information from children under the age of 13. If you think that
              your child provided this kind of information on our website, we strongly encourage you
